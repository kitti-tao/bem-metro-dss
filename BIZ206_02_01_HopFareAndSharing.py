...
fare_config_query = """
    SELECT * 
    FROM `bem-metro-dss.datamart_for_report.58_hop_config`
  """
...
shortest_path['FareTypeBL'] = 'HOP'
shortest_path['FareTypePPL'] = 'HOP'
...
result_to_bq(fare_table, client, dataset_id='datamart_for_report', dataset_table="hop_fare_table", write_disposition="WRITE_TRUNCATE")
