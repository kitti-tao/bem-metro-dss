...
fare_config_query = """
    SELECT * 
    FROM `bem-metro-dss.datamart_for_report.58_mix_config`
  """
...
shortest_path['FareTypeBL'] = config['FareType']['BL']
shortest_path['FareTypePPL'] = config['FareType']['PPL']
...
result_to_bq(fare_table, client, dataset_id='datamart_for_report', dataset_table="mix_fare_table", write_disposition="WRITE_TRUNCATE")
